...
(() => {
  ...
  function placeSticker(clickC, clickR) {
    ...
    // The clicked cell is the sticker's highest col/row cell (its
    // bottom-right corner), not its anchor - so the top-left anchor
    // sits back from the click by the sticker's own size.
    const c = clickC - wCols + 1;
